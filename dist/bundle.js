(() => {
  ...
  var normalizeQuestions = (questions2, _defaults) => {
  ...
  var questions = normalizeQuestions(preguntas, opcionesPorDefecto);
  var $form = document.createElement("step-form");
